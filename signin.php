...
//Kết nối databse và xài chùa thông tin
...
if (isset($_POST['user_signin']) && isset($_POST['pass_signin']))
{
    ...
    else
    {
        ...
        if ($db->num_rows($sql_check_user_exist))
        {
            ...
            {
                //Check trạng thái
                $sql_check_stt = "SELECT username, password, status FROM account WHERE username = '$user_signin' AND password = '$pass_signin' AND status = '0'";
